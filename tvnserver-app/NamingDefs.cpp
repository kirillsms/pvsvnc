...
const TCHAR ProductNames::SERVER_PRODUCT_NAME[] = _T("KonturVNC Server");

const TCHAR RegistryPaths::SERVER_PATH[] = _T("Software\\SKBKontur\\KonturVNC\\Server");
const TCHAR RegistryPaths::SERVER_REVERSE_CONN_HISTORY_PATH[] =
  _T("Software\\SKBKontur\\KonturVNC\\Control\\ReverseConnectionHistory");
const TCHAR RegistryPaths::DISPATCHER_CONN_HISTORY_PATH[] =
  _T("Software\\SKBKontur\\KonturVNC\\Control\\DispatcherConnectionHistory");

const TCHAR WindowNames::WINDOW_CLASS_NAME[] = _T("TvnWindowsApplicationClass");

const TCHAR LogNames::SERVER_LOG_FILE_STUB_NAME[] = _T("kvnserver");
const TCHAR LogNames::VIEWER_LOG_FILE_STUB_NAME[] = _T("kvnviewer");
const TCHAR LogNames::LOG_DIR_NAME[] = _T("KonturVNC");
const TCHAR LogNames::LOG_PIPE_PUBLIC_NAME[] = _T("KVN_log_pipe_public_name");
const TCHAR LogNames::WIN_EVENT_PROVIDER_NAME[] = _T("kvnserver");

const TCHAR ClipboardNames::CLIPBOARD_WIN_CLASS_NAME[] = _T("Kvnserver.Clipboard.MessageWindow");


const TCHAR ServiceNames::TVNCONTROL_START_REGISTRY_ENTRY_NAME[] =
  _T("kvncontrol");
const TCHAR ServiceNames::SERVICE_NAME[] = _T("kvnserver");
const TCHAR ServiceNames::SERVICE_NAME_TO_DISPLAY[] = _T("KonturVNC Server");

const TCHAR ServerApplicationNames::SERVER_INSTANCE_MUTEX_NAME[] =
  _T("kvnserverApplication");
const TCHAR ServerApplicationNames::CONTROL_APP_INSTANCE_MUTEX_NAME[] =
  _T("kvnserverServiceControlSlave");
const TCHAR ServerApplicationNames::FOR_SERVICE_CONTROL_APP_PIPE_NAME[] =
  _T("KonturVNC_Service_Control");
const TCHAR ServerApplicationNames::FOR_APP_CONTROL_APP_SERVICE_PIPE_NAME[] =
  _T("KonturVNC_Application_Control");

const TCHAR HookDefinitions::HOOK_LOADER_WINDOW_CLASS[] =
  _T("KvnHookLoaderWindowClass");
...
const UINT HookDefinitions::LOADER_CLOSE_CODE =
  RegisterWindowMessage(_T("KVN.HOOK.LOADER.CLOSE.CODE"));
const UINT HookDefinitions::SPEC_IPC_CODE =
  RegisterWindowMessage(_T("KVN.HOOK.MESSAGE.CODE"));

const TCHAR DefaultNames::DEFAULT_COMPUTER_NAME[] = _T("KonturVNC Server");


const char HttpStrings::HTTP_INDEX_PAGE_FORMAT[] =
"<HTML>\n"
"  <HEAD><TITLE>KonturVNC desktop [%.256s]</TITLE></HEAD>\n"
"  <BODY>\n"
...
"<HTML>\n"
"  <HEAD><TITLE>KonturVNC desktop</TITLE></HEAD>\n"
"  <BODY>\n"
