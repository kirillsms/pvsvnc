...
const TCHAR ProductNames::VIEWER_PRODUCT_NAME[] = _T("SkbTightVNC Viewer");

const TCHAR LogNames::VIEWER_LOG_FILE_STUB_NAME[] = _T("skbtvnviewer");
const TCHAR LogNames::LOG_DIR_NAME[] = _T("SkbTightVNC");

const TCHAR RegistryPaths::VIEWER_PATH[] = _T("Software\\SkbTightVNC\\Viewer");

const TCHAR ApplicationNames::WINDOW_CLASS_NAME[] = 
  _T("TvnApplicationClass");

const TCHAR WindowNames::TVN_WINDOW_CLASS_NAME[] = _T("SkbTvnWindowClass");
const TCHAR WindowNames::TVN_WINDOW_TITLE_NAME[] = _T("SkbTightVNC Viewer");
